...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'notificationsTitle': 'Family alerts',
      'notificationsSubtitle': 'Payments, room changes, and family updates show up here in real time.',
      'notificationsUnreadCount': '{count} unread alerts',
      'notificationsSeenAt': 'Last checked {time}',
      'notificationsListSubtitle': 'A clean timeline of recent updates across the property.',
      'notificationsDueSubtitle': '{count} rooms still need payment follow-up right now.',
      'recentAlerts': 'Recent alerts',
      'openInbox': 'Open inbox',
      'allCaughtUp': 'All caught up',
      'noNotificationsYet': 'No notifications yet',
      'noNotificationsSubtitle': 'When rent is recorded or rooms change, updates will appear here automatically.',
      'dueAttention': 'Due attention',
      ...
      'themeModeSubtitle': 'Follow your phone theme by default, or choose light or dark manually',
    ...
    'hi': {
      ...
      'themeMode': 'थीम मोड',
      'themeModeSubtitle': 'डिफ़ॉल्ट रूप से फ़ोन की थीम अपनाएँ, या लाइट या डार्क manually चुनें',
      'followDeviceTheme': 'डिवाइस थीम के साथ',
      'lightMode': 'लाइट मोड',
      'darkMode': 'डार्क मोड',
